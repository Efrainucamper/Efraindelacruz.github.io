...
function crear(e){
    ...
    if(localStorage.getItem("Libros") === null){
        ...
        letlibros = JSON.parse(localStorage.getItem("Libros"))
        libros.push(libro)
        localStorage.setItem("Libros", JSON.stringify(libros))
    }
...
function editar(titulo){
    let libros = JSON.parse(localStorage.getItem
    ("Libros"));
    for (let i=0; i<libros.length; i++)
            ...
            <div class="col-md-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <button class="btn btn-success"onclick="actualizar('$
                        {i}')">Actualizar</button>
...
//Funcion para mostrar la inferfaz principal
    ...
    <div class="col-md-5">
        <div class="card">
            <div class="card-header">
                ...
                <form id="formulario">
                    <div class="form-group">
                        <imput type="text" id="titulo" class="form-control my-3"placeholder="Ingresar titulo">
                     </div>
                     <div class="form-group">
                        <textarea id="descripcion" class="form-control my-3"placeholder="Ingresar descripcion"></textarea>
                     </div>
                     <div class="form.group">
